    ...
    <div className={styles.desktop1}>
      <div className={styles.frameParent}>
        ...
        <div className={styles.frameContainer}>
          ...
          <div className={styles.auctionsGroup}>
            <AuctionsContainer
              imageIds="/image-73@2x.png"
              smallImageIds="/blurText13@2x.png"
              image58Opacity="0"
              frame34323Opacity="0"
              image29="/image-2918@2x.png"
              image29Top="-5.77%"
              image29Right="-7.69%"
              image29Bottom="-9.61%"
              image29Left="-7.69%"
              image291="/image-2918@2x.png"
              image29Top1="-5.77%"
              image29Right1="-7.69%"
              image29Bottom1="-9.61%"
              image29Left1="-7.69%"
              ...
              image29Bottom2="-9.61%"
              image29Left2="-7.69%"
              image293="/image-2918@2x.png"
              image29Top3="-5.77%"
              image29Right3="-7.69%"
              image29Bottom3="-9.61%"
              image29Left3="-7.69%"
              image294="/image-2918@2x.png"
              image29Top4="-5.77%"
              image29Right4="-7.69%"
              image29Bottom4="-9.61%"
              image29Left4="-7.69%"
              verified2="/verified-21@2x.png"
              frame34288Opacity="0"
              rectangle3320Top="48px"
              rectangle3320Left="124px"
              rectangle3320Width="48px"
              rectangle3320Height="124px"
              group34290Opacity="0"
              timeGainedTop="463px"
              propTop="463px"
            />
