import styles from "./PostCardAsset.module.css";
const PostCardAsset = () => {
  return (
    <div className={styles.postcardasset}>
      <div className={styles.postcard}>
        <div className={styles.auctions}>
          <img className={styles.image50Icon} alt="" src="/image-49@2x.png" />
